...
function getWeather(city){
    $.get("http://api.openweathermap.org/data/2.5/weather?q="+city+"&units=imperial&appid=8ba3c706807866821bda266dc0c939e8", function(data){
      console.log(data);
    ...
    $.get("http://api.openweathermap.org/data/2.5/forecast?q="+city+"&units=imperial&appid=8ba3c706807866821bda266dc0c939e8", function(data){
    console.log(data);


  var dayOne = moment().format("D/M/YYYY");
  ...
  var dayTwo = moment().add(1, "days").format("D/M/YYYY");
  ...
  var dayThree = moment().add(2, "days").format("D/M/YYYY");
  ...
  var dayFour = moment().add(3, "days").format("D/M/YYYY");
  ...
  var dayFive = moment().add(4, "days").format("D/M/YYYY");
